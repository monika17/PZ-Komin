...
initialiserUrl+="&"+$iTXT.js.pageQuery;initialiserUrl+=this.checkDynamicAdhesionSuppression();$iTXT.fire("$iTXT:initialiser:drop",this);$itxtUtil.dropScript(initialiserUrl,$iTXT.core.Event.bind(this,this.initialiserLoad));}},initialiserLoad:function(cbr)
...
{$itxtUtil.dropScript(s);this.scriptDropped=true;}},checkDynamicAdhesionSuppression:function()
{if(window.vmNoBanner)
{return"&noda";}
else
{return"";}}});if(undefined==$iTXT.itxt.currentController)
